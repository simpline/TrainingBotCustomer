...
module.exports = (robot) ->
  robot.respond /ご用件を伺いに来ました。/i, (res) ->
    ...
    res.reply "上長に「お客様からWordpressを立ててほしいと頼まれました。」と相談してください。"
  ...
  robot.respond /Wordpressを立てたことを報告しに来ました。/i, (res) ->
    ...
    res.reply "上長に「お客様からMovableTypeに変更してほしいと頼まれました。」と相談してください。"
  ...
  robot.respond /復旧したことを報告しに来ました。.*/i, (res) ->
    ...
    res.reply "上長に「お客様から壊れたことを気づく仕組みを作ってほしいと頼まれました。」と相談してください。"
